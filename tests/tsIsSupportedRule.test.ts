...
test("Should not have any issues", () => {
    ...
    expect(executeRule(
        ...
        `,
        {
            targets: {ie: 3, firefox: "*", chrome: "*", edge: "*", opera: "*", safari: "*", firefox_android: "*", chrome_android: "*", safari_ios: "*", samsunginternet_android: "*", webview_android: "*", nodejs: "*"},
        },
    )).toEqual([]);
    ...
    expect(executeRule(
        ...
        `,
        {
            targets: {ie: ">=5.5", firefox: "*", chrome: "*", edge: "*", opera: "*", safari: "1.1", firefox_android: "*", chrome_android: "*", safari_ios: "*", samsunginternet_android: "*", webview_android: "*", nodejs: "*"},
        },
    )).toEqual([]);
...
test("Issues should match", () => {
    ...
    expect(executeRule(
        ...
        {
            sourceLineNum: 0,
            issue: {featureName: "Window.requestAnimationFrame", clientInfo: {name: "opera"}, kind: IssueKind.NEEDS_PREFIX, altOrPrefix: "o", endVersion: {major: 15}},
        },
    ]);
    ...
    expect(executeRule(
        ...
        `,
        {
            targets: {ie: 11, edge: "<=13", firefox: 63, opera: 13, safari_ios: "*"},
        },
    )).toMatchObject([
        {
            sourceLineNum: 2,
